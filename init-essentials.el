...
(use-package frame
  ...
  (let*
      (
       ;; Version 1: deprecated 2023-06-22 (for default windows theme)
       ...
       ;; Version 2: works with starwars windows theme
       (calculated-frame-height
...
(use-package virtualenvwrapper
  ...
  ;;;~ include python packages required for bioinformatics : "biopython"
    (venv-with-virtualenv-shell-command
     "biopython" "pip install epc jedi pytz pubchempy rdkit biopython")
    )
